...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2022 at 08:00 AM
...
(1, 'Original Classic 400g', 2.8, 35, 'classic400g.png', 18),
(2, 'Original Classic Jumbo 600g', 4, 31, 'classic600g.png', 18),
...
(18, 'Twiggies Choc-A-Lot', 1.8, 30, 'twiggiesChoc76g.png', 17),
...
(1, 'Admin', 'A', 'admin@admin.com', '60101234567', 'Sarawak', 'Female', '$2y$10$4AFnQTlsFUaKMxuRuXgQ0e8ShlQVwACfe6KrgYtwVdzolMWwjEYzq', 'admin', NULL),
...
(19, 'James', 'Bond', 'jamesbond@gmail.com', '60266699976', 'Johor', 'Male', '$2y$10$plM/0kHAjB.KCfzoIVyZR.HZyUtv1YlXbgByQFZyhGHjuPv5HC8pe', 'user', NULL),
(20, 'Jeremi Kek', 'Fong', '75162@siswa.unimas.my', '60122222222', 'Johor', 'Male', '$2y$10$K5oe8tuebPOYoLL1muCxzuJZQdOPrTgZR9gm7ZKzTX4miopmoSERy', 'user', NULL),
(21, 'Chuah', 'Wen Juin', '74487@siswa.unimas.my', '60105510010', 'Perak', 'Male', '$2y$10$Y3J18i4EIb6feTfLuQfypez74Z.NLYiCl.ghEXdbDgQiwl6DbIesm', 'user', '21.jpg'),
...
(31, 'Hazel', 'Ng', 'hazel96@gmail.com', '601234567890', 'Pulau Pinang', 'Female', '$2y$10$iNf26oYB53aGtxnHEvk3teW/Spxm26nLD5Atx/Utpu9J4eOHwCX5K', 'user', NULL),
(33, 'Michael', 'Jackson', 'heehee@gmail.com', '+60123456789', 'Melaka', 'Male', '$2y$10$LOUg8c19ED3O7ZaotNnFB.I2j4BYMzzjPNd/l9JxiFyscqoQOhfvK', 'user', '33.jpg'),
(35, 'Test', 'Test', 'test@gmail.com', '60222222222', 'Johor', 'Male', '$2y$10$tB.XJTeiZl69gnkCZGNKiuRRP7JGKo/H9Q2G1PApy8sE2OrSPqvj.', 'user', '35.png'),
(40, 'Eric', 'Cartman', 'sp_cartman@outlook.com', '601234567890', 'Kuala Lumpur', 'Male', '$2y$10$oLSw.RP0W6B1dGUTmBkff.sAVhvweoTETf64KwigbZD4ynVJvNu5a', 'user', NULL),
(42, 'Monka', 'Giga', 'monkas@gmail.com', '60222222222', 'Johor', 'Male', '$2y$10$VWWCPfdiXmeG.CP76ZO95.pi.k6vdReBgL29/g/SyGwdmVfmnUlA.', 'user', NULL),
(45, 'Jojo', 'Stardust', 'test@test.com', '601234567890', 'Sarawak', 'Female', '$2y$10$Xsxoi5gb7bRaD1h81BXCZeqODFVbVhx/ow05YW2g0ynGd48Mslvtm', 'user', NULL),
(46, 'Golden', 'Wind', 'requiem@gmail.com', '60222222222', 'Johor', 'Male', '$2y$10$dClwHNMliUua9hvvPVZUFOojhovjU.BUSBeNlEce58M51vTzKkHOu', 'user', NULL),
(49, 'Testing', 'Test', 'test2@gmail.com', '60222222222', 'Johor', 'Male', '$2y$10$yj.WIJQoBP/2S5iJcDTTeeY7b5M85StP9RNAkNTcT859btq0ZmHTC', 'user', NULL);
...
INSERT INTO `user_11` (`ProductID`, `ProductName`, `Price`, `Quantity`) VALUES
(3, 'Wholemeal Bread 400g', 3.6, 4),
(2, 'Original Classic Jumbo 600g', 4, 1),
(17, 'Delicia Butterscotch 360g', 5, 1),
(3, 'Wholemeal Bread 400g', 3.6, 4),
(2, 'Original Classic Jumbo 600g', 4, 1),
...
INSERT INTO `user_14` (`ProductID`, `ProductName`, `Price`, `Quantity`) VALUES
(10, 'Toast’em Pandan Coconut', 5, 1),
(21, 'QuickBites Butter Sugar Cream Roll', 1, 1),
(10, 'Toast’em Pandan Coconut', 5, 1),
(21, 'QuickBites Butter Sugar Cream Roll', 1, 1);
...
INSERT INTO `user_17` (`ProductID`, `ProductName`, `Price`, `Quantity`) VALUES
(17, 'Delicia Butterscotch 360g', 5, 1),
(19, 'QuickBites Chocolate Cream Roll', 1, 2),
(17, 'Delicia Butterscotch 360g', 5, 1),
(19, 'QuickBites Chocolate Cream Roll', 1, 2);
